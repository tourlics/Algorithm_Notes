...
博客地址：[寻找对称日（回文）（包括闰年的判断）](https://www.cnblogs.com/icodes8238/p/12253343.html)
...
* 博客地址：[数学问题](https://www.cnblogs.com/icodes8238/p/12295037.html)
...
* 博客地址：[筛数法求素数+回文判断](https://www.cnblogs.com/icodes8238/p/12253353.html)
...
* 博客地址：[大整数加法、减法、乘法、除法](https://www.cnblogs.com/icodes8238/p/12298324.html)
...
* 代码整合：博客地址：[AVL Tree](https://www.cnblogs.com/icodes8238/p/12294678.html)
...
博客地址：[Tarjan算法求有向图强联通分量及其拓展](https://www.cnblogs.com/icodes8238/p/12245089.html)
...
* 下面介绍求关键路径的另一种算法
  ...
  * 总体思路：按结点拓扑排序的顺序求出事件的最早发生时间和最迟发生时间，然后根据活动的最早发生时间和最迟发生时间与事件最早最迟发生时间的关系，找出活动最早等于活动最迟发生时间的那些活动，就是关键路径
  * 关键活动都是不允许拖延的活动，因此这些活动的特点是活动的最早发生时间等于活动的最迟发生时间
  * **事件的最早发生时间：ve[k]**
...
* Ford-Fulkerson算法（基于dfs）
  * [理论基础](https://www.cnblogs.com/ShaneZhang/p/3755479.html)
  * [代码实现](https://blog.csdn.net/karry_zzj/article/details/70832706)
  * [最大流和最小割的等价性](https://www.freesion.com/article/857610082/)

### 11. 最小费用最大流

* 在满足最大流的同时找到达成最大流的最小费用
...
* 详见 博客地址：[寻找第K大的数](https://www.cnblogs.com/icodes8238/p/12243155.html)

### 2. 字符串匹配

* 博客地址：[字符串匹配算法（RK算法和KMP算法）](https://www.cnblogs.com/icodes8238/p/12301055.html)

### 3. 分治法
* 博客地址：[最短距离点对问题（几何中的分治法）](https://www.cnblogs.com/icodes8238/p/12630001.html)
